            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="verifica-dati">         
                        <h5>Prima di effettuare il pagamento, verifica i tuoi dati personali:</h5>
                        <form class="form-horizontal" role="form">
                            <div class="form-group">
                            ...
                            <input type="date" id="data" value="<%if(sesuser.datanascita!=null){out.println(sesuser.datanascita);}else{out.print("");}%>"></input>
                                          <span class="add-on">
                            ...
                            <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" required id="luogonas" name="luogonas" value="<%if(sesuser.luogonascita!=null){out.println(sesuser.luogonascita);}else{out.print("");}%>">
                            </div>
                            <input type="submit" value="next" class="btn btn-warning" id="next" />
                        </form>
